...
public class Imovel {
    ...
    public Imovel(Bairro bairro, String area, String endereco, String finalidade){
        setBairro(bairro);
        if (area == null) {
            throw new IllegalArgumentException("Área nao pode ser vazia");
        }        
        setArea(Integer.parseInt(area));
        setEndereco(endereco);
        if (finalidade == null){
            throw new IllegalArgumentException("Finalidade nao pode ser vazia");
        }
    ...
    if (area <= 0) {
        throw new IllegalArgumentException("Area nao pode ser menor que um.");
    }
    this.area = area;
}
    ...
    public double calcularIptu() {
        if (bairro == null) {
            throw new IllegalArgumentException("Bairro nao pode ser vazia.");
        }
        if (finalidade == null) {
            throw new IllegalArgumentException("Finalidade do imóvel não pode ser vazia.");
        }
